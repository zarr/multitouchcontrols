$(function () {
    ...
    addControl(group3, sliderControl, 'own voice', '/ch/02/mix/02/level');
    addControl(group3, sliderControl, 'caster 1', '/ch/01/mix/02/level');
    addControl(group3, sliderControl, 'guest', '/ch/03/mix/02/level');
    addControl(group3, sliderControl, 'game', '/ch/05/mix/02/level');
    addControl(group3, sliderControl, 'talkback', '/ch/17/mix/02/level');

    addControl(group4, sliderControl, 'own voice', '/ch/01/mix/01/level');
    addControl(group4, sliderControl, 'caster 2', '/ch/02/mix/01/level');
    addControl(group4, sliderControl, 'guest', '/ch/03/mix/01/level');
